            ...
            <div class="page">
                <section className="grey section">
                    <div className="card">
                        ...
                        <p>(You can also explore our slides on filters (slide 28) from our <a target="_blank" class="bluelink" style={{color: '#FF00F5'}} href="https://teachla.uclaacm.com/classes/ml/10-cnn" rel="noopener noreferrer">CNN high-school lesson)</a></p>
